...
extern volatile CAN_RxMessage_t canLastTxMsg;
...
extern volatile uint32_t canRxCallbackCount;
extern volatile uint32_t canRxPollCount;
extern volatile uint32_t canRxQueuePutCount;
extern volatile uint32_t canBspInitOk;
extern volatile uint32_t canBspInitError;
extern volatile uint32_t can1NotifyOk;
extern volatile uint32_t can2NotifyOk;
